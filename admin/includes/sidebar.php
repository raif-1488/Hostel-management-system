...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="log.php"
        aria-expanded="false"><i class="fas fa-user-circle"></i><span
        class="hide-menu">Log of girls</span></a></li>
        
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="late-entry-log.php"
        aria-expanded="false"><i class="fas fa-user-circle"></i><span
        class="hide-menu">Late Entry</span></a></li>
