            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            <a href="add-students.php"><button type="button" class="btn btn-block btn-md btn-success">Add New Student Details</button></a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <td><a href="edit-students.php?id=<?php echo $row->id;?>" title="Edit"><i class="icon-note"></i></a>&nbsp;&nbsp;
                                        </tr>
                                            <?php
                                        $cnt=$cnt+1;
                                            } ?>
